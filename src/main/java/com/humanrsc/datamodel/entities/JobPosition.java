...
@Entity
@Table(name = "job_positions", schema = "hr_app")
@Getter
@Setter
@Audited
public class JobPosition {
    ...
    private Integer hierarchicalLevel = 1;
    ...
    @CollectionTable(
        name = "job_positions_extended_attributes",
        schema = "hr_app",
        joinColumns = {
            @JoinColumn(name = "id"), 
    ...
    public boolean hasHierarchicalLevel() {
        return hierarchicalLevel != null && hierarchicalLevel > 0;
    }

    public boolean hasJobCode() {
        return jobCode != null && !jobCode.trim().isEmpty();
    }

    @Override
    public String toString() {
        return "JOB_POSITION{" + objectID + ", title='" + title + "'}";
    }
